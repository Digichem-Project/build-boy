...
- CentOS-7.9: <!-- CentOS-7.9 --> [6.0.0-pre.4](https://github.com/Digichem-Project/build-boy/releases/download/6.0.0-pre.4-CentOS-7.9/digichem.6.0.0-pre.4.CentOS-7.9.tar.gz)
- CentOS-8.5: <!-- CentOS-8.5 --> [6.0.0-pre.4](https://github.com/Digichem-Project/build-boy/releases/download/6.0.0-pre.4-CentOS-8.5/digichem.6.0.0-pre.4.CentOS-8.5.tar.gz)

### CentOS Stream (Redhat > 8.5)
- CentOS-Stream-8: <!-- CentOS-Stream-8 --> [6.0.0-pre.4](https://github.com/Digichem-Project/build-boy/releases/download/6.0.0-pre.4-CentOS-Stream-8/digichem.6.0.0-pre.4.CentOS-Stream-8.tar.gz)
