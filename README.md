...
- CentOS-Stream-8: <!-- CentOS-Stream-8 --> [6.1.0](https://github.com/Digichem-Project/build-boy/releases/download/6.1.0-CentOS-Stream-8/digichem.6.1.0.CentOS-Stream-8.tar.gz)
