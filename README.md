...
- CentOS Stream 8: <!-- CentOS-Stream-8 --> [Download Digichem v6.8.1-pre.1](https://github.com/Digichem-Project/build-boy/releases/download/6.8.1-pre.1-CentOS-Stream-8/digichem.6.8.1-pre.1.CentOS-Stream-8.tar.gz)
