...
- CentOS-7.9: <!-- CentOS-7.9 --> [6.4.0](https://github.com/Digichem-Project/build-boy/releases/download/6.4.0-CentOS-7.9/digichem.6.4.0.CentOS-7.9.tar.gz)
- CentOS-8.5: <!-- CentOS-8.5 --> [6.4.0](https://github.com/Digichem-Project/build-boy/releases/download/6.4.0-CentOS-8.5/digichem.6.4.0.CentOS-8.5.tar.gz)

### CentOS Stream (Redhat > 8.5)
- CentOS-Stream-8: <!-- CentOS-Stream-8 --> [6.3.0](https://github.com/Digichem-Project/build-boy/releases/download/6.3.0-CentOS-Stream-8/digichem.6.3.0.CentOS-Stream-8.tar.gz)
