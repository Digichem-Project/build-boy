...
- CentOS-8.5: <!-- CentOS-8.5 --> [6.1.0-pre.0](https://github.com/Digichem-Project/build-boy/releases/download/6.1.0-pre.0-CentOS-8.5/digichem.6.1.0-pre.0.CentOS-8.5.tar.gz)
