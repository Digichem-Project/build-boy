...
- CentOS-8.5: <!-- CentOS-8.5 --> [6.0.0-pre.11](https://github.com/Digichem-Project/build-boy/releases/download/6.0.0-pre.11-CentOS-8.5/digichem.6.0.0-pre.11.CentOS-8.5.tar.gz)
