...
- CentOS-Stream-8: <!-- CentOS-Stream-8 --> [6.0.0-pre.15](https://github.com/Digichem-Project/build-boy/releases/download/6.0.0-pre.15-CentOS-Stream-8/digichem.6.0.0-pre.15.CentOS-Stream-8.tar.gz)
