...
- CentOS-7.9: <!-- CentOS-7.9 --> [6.0.0-pre.16](https://github.com/Digichem-Project/build-boy/releases/download/6.0.0-pre.16-CentOS-7.9/digichem.6.0.0-pre.16.CentOS-7.9.tar.gz)
