...
1. Download <!-- Quick-Download --> [Digichem](https://github.com/Digichem-Project/build-boy/releases/download/7.3.2-CentOS-Stream-8/digichem.7.3.2.CentOS-Stream-8-blender.tar.gz), or use one of the specific versions below.
